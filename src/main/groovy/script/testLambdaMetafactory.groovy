...
MethodType invokedMethodType = MethodType.methodType(Supplier.class, []);
...
java.lang.invoke.CallSite callSite = LambdaMetafactory.metafactory(
        ...
        handle,  //lookup.findVirtual(ExampleClass.class, "getValue", MethodType.methodType (String.class)),
